...
Validation.validProjectName = function (name) {
    var error = "";
    if (!name) {
        $('#form-group-pr-name').removeClass('has-success').addClass('has-error');
        ...
        if(name.length > 300) {
            ...
            $('#form-group-pr-name').removeClass('has-error').addClass('has-success');
        }
    }
    return error;
};

Validation.validIssueName = function (name) {
    var error = "";
    if (!name) {
        $('#form-group-is-name').removeClass('has-success').addClass('has-error');
        error += "Name is required! ";
    } else {
        if(name.length > 300) {
            $('#form-group-is-name').removeClass('has-success').addClass('has-error');
            ...
            $('#form-group-is-name').removeClass('has-error').addClass('has-success');
        }
    }
    return error;
};
...
Validation.validProjectDescription = function () {
    $('#form-pr-group-desc').removeClass('has-error').addClass('has-success');
    return "";
};

Validation.validIssueDescription = function () {
    $('#form-group-is-desc').removeClass('has-error').addClass('has-success');
    return "";
};
